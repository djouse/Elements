...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border bg-clip-padding text-md font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "border-border bg-muted transition duration-300 ease-in-out hover:bg-muted-neutral hover:border-muted-neutral hover:text-foreground active:bg-muted-neutral aria-expanded:bg-muted-neutral aria-expanded:text-foreground",
        outline:
        ...
        simplified: "border-transparent text-primary hover:font-bold",
      },
      size: {
        default:
